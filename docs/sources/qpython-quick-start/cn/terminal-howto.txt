...
-----------------------
它与电脑上的Python终端无异, 大多数人通常使用它来探索对象的属性, 测试语法或实现他们的想法. 你可以直接输入命令, Python解释器会帮你运行它们. 你还可以:

* 通过点击左上角的加号按钮新建, 或点击下拉列表切换不同的终端。
* 需点击下拉列表中对应窗口的关闭按钮。

.. image:: http://edu.qpython.org/static/terminal-menu.png
    :alt: QPython - Terminal 弹出菜单

此外，如果你在长按终端窗口，你可以通过弹出菜单来完成类似选择文本，拷贝所有内容，粘贴，发送control键，发送fn键等复杂的操作。

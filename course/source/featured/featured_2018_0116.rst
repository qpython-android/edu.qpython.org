...
Evaluation methods
-----------------------
At the end of the month, we will issue a document on this public account to list the entries, Each contest will  voted the user selected the most Pythonic code winner, Domestic winners receive QPython T-Shirt or themed souvenirs.
